const polkadotExtensionDapp = (function (exports, util, utilCrypto) {
  ...
  function mapAccounts(source, list, ss58Format) {
    return list.map(({
      ...
      const encodedAddress = utilCrypto.encodeAddress(utilCrypto.decodeAddress(address), ss58Format);
      return {
  ...
  function web3Enable(originName) {
    ...
    exports.web3EnablePromise = documentReadyPromise(() => getWindowExtensions(originName).then(values => values.filter(value => !!value[1]).map(([info, ext]) => {
